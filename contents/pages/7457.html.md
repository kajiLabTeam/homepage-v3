...
updated_at: '2026-06-26T14:16:42+09:00'
published: true
number: 7457
---
...
# 2026
<!-- DICOMO -->
- 多田隆人, 梶克彦, 水野公博, 内藤彩乃, 中條直也, 水野忠則：3次元の骨格情報と位置情報を相補的に用いた調理行動の分類精度向上手法, DICOMO 2026 シンポジウム, 2026.
- 丹羽慧, 梶克彦：スマートフォンとワイヤレスイヤホンを用いたマーチング動作の分析, DICOMO 2026 シンポジウム, 2026.<span style="color: red;">(ヤングリサーチャー賞)</span>

<!-- CDS論文誌 -->
- 上地 勇輔, 梶 克彦：指輪型センシングデバイスを用いたヨーヨーの技能分析システム, 情報処理学会論文誌 コンシューマ・デバイス & システム Vol.16, 2026
- 戸川 浩汰, 梶 克彦：プライバシを考慮した携帯型 BLE ビーコンデバイスとその識別システム, , 情報処理学会論文誌 コンシューマ・デバイス & システム Vol.16, 2026

<!-- 全国大会 -->
- 胡麻本城太郎, 梶克彦：時空間的な環境情報を蓄積するクラウドセンシング基盤の提案, 第88回情報処理学会全国大会, 2026.
- 多田隆人, 梶克彦, 水野公博, 内藤彩乃, 中條直也, 水野忠則：行動認識に基づく調理行動の位置補正手法, 第88回情報処理学会全国大会, 2026.<span style="color: red;">(学生奨励賞)</span>
- 井上翔人, 梶克彦：コミュニティ空間への訪問促進を目的としたゲームプレイ推定通知システム, 第88回情報処理学会全国大会, 2026.

<!-- インタラクション -->
- 柴田青賢, 長尾確, 梶克彦：同一現実空間におけるMR共創環境の実装と評価, インタラクション2026, 2026.
- 町田渉, 梶克彦：創作物におけるライセンス情報の構造化とそれに基づく互換性評価システム, インタラクション2026, 2026.

<!-- CDS -->
- 牧野遥斗, 梶克彦：UWBアンテナとスマートフォンの融合により配置の柔軟性を向上させた屋内測位システム, 第45回CDS研究発表会, CDS45-07, 2026.<span style="color: red;">(学生奨励賞)</span>
- 中島瑞希, 梶克彦：環境コレクション:多様な環境の体験を促すスマートフォンアプリ, 第45回CDS研究発表会, CDS45-08, 2026.

# 2025
<!-- HCGシンポジウム -->
- 長尾夏希, 多田隆人, 丹羽慧, 水野楓希, 酒井翔琉, 梶克彦：UWB・VISO・PDR の切り替えによる位置推定, HCGシンポジウム2025, 2025.<span style="color: red;">(特集テーマセッション賞)</span>

<!-- WiNF -->
- 加藤風真, 梶克彦, 水野公博, 内藤彩乃, 中條直也, 水野忠則：複数レシピ間の類似動作を用いた調理動作共有比較分析 Web システムの提案, WiNF2025(第23回情報学ワークショップ), 2025.
- 粟生将之, 梶克彦：心拍情報を用いた人狼ゲームにおける推理支援システムの提案, WiNF2025(第23回情報学ワークショップ), 2025.<span style="color: red;">(優秀賞)</span>
- 中島瑞希, 梶克彦：環境コレクション, WiNF2025(第23回情報学ワークショップ), 2025.
- 佐藤綾花, 梶克彦：在室予測に基づく帰宅同行支援システム, WiNF2025(第23回情報学ワークショップ), 2025.<span style="color: red;">(奨励賞)</span>
- 石井美帆, 梶克彦：移動履歴からの滞在区間抽出に基づく滞在比較システム, WiNF2025(第23回情報学ワークショップ), 2025.
- 胡麻本城太郎, 梶克彦：時空間的な環境情報を蓄積するクラウドセンシング基盤の基礎検討, WiNF2025(第23回情報学ワークショップ), 2025.
- 正木雄也, 梶克彦：手首の軌跡および包丁の姿勢推定に基づく刺身を切る動作の技能分析に関する研究, WiNF2025(第23回情報学ワークショップ), 2025.

<!-- MBL -->
- 山口隼, 牧野遥斗, 梶克彦： 分散滞在管理システム間の匿名フィンガープリント共有による滞在推定精度向上手法, 第117回モバイルコンピューティングと新社会システム・第103回高度交通システムとスマートコミュニティ合同研究発表会, 2025.

<!-- ICMU -->
- Yusuke Ueji,Katsuhiko Kaji:Skill Analysis of Yo-Yo Performance Using a Ring-Type Sensing Device,The 15th International Conference on Mobile Computing and Ubiquitous Networking(ICMU2025),2025.<span style="color:red;">(Best Demo Award)</span>
- Ryuto Tada,Katsuhiko Kaji,Kimihiro Mizuno,Ayano Naito,Naoya Chujo,Tadanori Mizuno:Method for Improving Cooking Activity Classification Accuracy Using Location Information and Procedure Documents,The 15th International Conference on Mobile Computing and Ubiquitous Networking(ICMU2025),2025.<span style="color:red;">(Best Poster Award)</span>

<!-- IWIN -->
- Koki Fuseya,Katsuhiko Kaji:Rhythm Rally:Entertainment Sport Combining Table Tennis and Rhythm Game,International Workshop on Informatics(IWIN2025),2025.<span style="color: red;">(Best Presentation Award)</span>
- Kohei Hayashi,Katsuhiko Kaji:Propose of Visit Promotion System Based on Visit Prediction and Common Topics,International Workshop on Informatics(IWIN2025),2025.

<!-- DICOMO -->
- 加藤風真, 熊澤綾人, 梶克彦, 水野公博, 内藤彩乃, 中條直也, 水野忠則： 	調理行動比較分析に基づく成長を促すフィードバックの検討, DICOMO 2025 シンポジウム, 2025.
- 多田隆人, 梶克彦, 水野公博, 内藤彩乃, 中條直也, 水野忠則,：位置情報と手順書を用いた調理行動の分類精度向上手法, DICOMO 2025 シンポジウム, 2025.
- 伏屋恒輝, 梶克彦：リズムラリー：卓球とリズムゲームを組み合わせたエンタメスポーツ, DICOMO 2025 シンポジウム, 2025.
- 林航平, 梶克彦：未来の在室状況予測と共通の話題に基づく来訪促進システムの提案, DICOMO 2025 シンポジウム, 2025.

<!-- CDS研究会 -->
- 戸川浩汰, 梶克彦：滞在推定システムにおけるプライバシを考慮した携帯型BLEビーコンの設計と実装, 第43回CDS研究発表会, 2025.<span style="color: red;">(優秀発表賞)</span>
- 上地勇輔, 梶克彦：指輪型センシングデバイスを用いたヨーヨーの技能分析, 第43回CDS研究発表会, 2025.<span style="color: red;">(学生奨励賞)</span>

<!-- 全国大会 -->
- 柴田青賢, 梶克彦：複数のMRコンテンツを統一的に利用できるMRアプリの基礎検討, 第87回情報処理学会全国大会, 2025.<span style="color: red;">(学生奨励賞)</span>
- 戸川浩汰, 梶克彦：滞在推定システムにおけるプライバシを考慮した携帯型BLEビーコンの基礎検討, 第87回情報処理学会全国大会, 2025.<span style="color: red;">(学生奨励賞)</span>
- 多田隆人, 梶克彦：モーションキャプチャで得られる3次元の骨格情報を用いた調理行動の分類に関する基礎検討, 第87回情報処理学会全国大会, 2025.<span style="color: red;">(学生奨励賞)</span>
...
- Rui Yamaguchi and Katsuhiko Kaji :“A Method for Estimating Bicycle Air Pressure Decrease based onVibration Sensing of Bicycles using Smartphone,” International Journal of Informatics Society, Vol.16, No.2, pp.84-93, 2024.
