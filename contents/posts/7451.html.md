...
updated_at: '2025-06-26T15:50:44+09:00'
published: true
number: 7451
---
...
# 追加 / 編集の詳細
## 下書き
esa 保存時に `Save as WIP` とすると下書きになります
下書きの場合は一覧に表示されなくなります
直接リンクを入れることでページを確認できます

一度でも `Ship It` した記事は `WIP` しても下書きにはなりません ※esaの仕様上

投稿のURLは通常 `https://kajilab.net/post/{yyyy}-{mm}-{dd}_{esa の番号}/` となります
投稿日を変更した場合はその日時になります
